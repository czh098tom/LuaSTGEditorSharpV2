...
{
    [NodeCreationMenu("Pattern/Operator", TitleKey = "linqstg_window_node_takeWhilePattern", Order = 9)]
    public class TakeWhilePatternNode : LinqSTGNodeViewModel
    {
        ...
        public TakeWhilePatternNode()
        {
            ...
            Name = global::LuaSTGEditorSharpV2.Package.LinqSTG.Windows.Resources.Localized.linqstg_window_node_takeWhilePattern;
