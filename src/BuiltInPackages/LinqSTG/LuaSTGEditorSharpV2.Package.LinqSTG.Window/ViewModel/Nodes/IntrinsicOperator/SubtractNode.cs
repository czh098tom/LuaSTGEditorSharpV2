...
{
    [NodeCreationMenu("Operator", EnglishTitle = "Subtract (-)", Order = 1)]
    public class SubtractNode : LinqSTGNodeViewModel
    {
        ...
        public SubtractNode()
        {
            ...
            NumericResult.Value = NumericA.ValueChanged.CombineLatest(NumericB.ValueChanged, TrySubtract);
        }

        private static object? TrySubtract(object? lhs, object? rhs)
        {
