...
{
    [NodeCreationMenu("Operator", EnglishTitle = "Multiply (*)", Order = 2)]
    public class MultiplyNode : LinqSTGNodeViewModel
    {
        ...
        public MultiplyNode()
        {
            ...
            NumericResult.Value = NumericA.ValueChanged.CombineLatest(NumericB.ValueChanged, TryMultiply);
        }

        private static object? TryMultiply(object? lhs, object? rhs)
        {
